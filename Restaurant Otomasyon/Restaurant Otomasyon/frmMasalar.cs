               ...
               foreach(Control item in this.Controls)
                {
                    if(item is Button)
                    {
                        ...
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.Screenshot_131);
                        }
                        else if(item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "2")
                        {
                            ...
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.Screenshot_16);
                        }
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "3")
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.Screenshot_17);
                        }
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "4")
                        {
                            item.BackgroundImage = (System.Drawing.Image)(Properties.Resources.Screenshot_18);
                        }
                    }
                }
            }
